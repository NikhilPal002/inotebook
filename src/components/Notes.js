        ...
        <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <div onClick={handleClick} type="button" className="btn saveBtn" style={{ color: '#ffffff', backgroundColor: '#12de93' }}>Save Changes</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className='row my-3'>
                    ...
                    {notes.length === 0 && <h5 style={{ color: '#12de93' }}>No Note Yet!!</h5>}
                    {notes.map((note) => {
