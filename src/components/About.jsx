    ...
    return (
        <>
            <style jsx="true">
                {`  
                    .signup:hover{
                        background-color: #06543a !important;
                    }
            ...
            <div className='container col-md-6 center'>
                ...
                <h4 className="text-center para">All your notes, synced on all your devices. <span className="fw-bold" to="/">i<span style={{ color: '#12de93' }}>Note</span>book</span> now for iOS, Android, Mac, Windows, Linux, or in your browser.</h4>
                <Link className="btn my-2 signup" to='/signup' style={{ backgroundColor: '#12de93', color: '#ffffff', textDecoration: 'none', outline: '0', boxShadow: 'none' }}>Sign Up Now</Link>
            </div>
