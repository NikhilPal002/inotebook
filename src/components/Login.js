    ...
    return (
        <>
            ...
            <div className='mt-4 container center'>
                <h3 className="navbar-brand fw-bold">Welcome to i<span style={{ color: '#12de93' }}>Note</span>book</h3>
                <div className="card bg-light col-xxl-4 col-md-6">
                    <div className="card-body">
                        <div className="mb-3">
                            <label htmlFor="email" className="form-label"> <i className="bx bxs-envelope" style={{ color: '#12de93' }}></i> Email address</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="password" className="form-label"><i className="bx bxs-lock" style={{ color: '#12de93' }} ></i> Password</label>
